...
def minimize(function, initial, alpha=1.0, beta=2.0, gamma=0.5, epsilon=1e-5, repeat=int(1e6), verbose=False):
    ...
    iter=000, params=(0.00,1.30), (1.00,1.00), (0.30,0.00), scores3.09, 3.58, 4.69
    iter=001, params=(0.00,1.30), (0.60,1.72), (1.00,1.00), scores3.09, 3.27, 3.58
    iter=002, params=(0.00,1.30), (0.65,1.26), (0.60,1.72), scores3.09, 3.12, 3.27
    iter=003, params=(0.46,1.50), (0.00,1.30), (0.65,1.26), scores3.07, 3.09, 3.12
    iter=004, params=(0.44,1.33), (0.46,1.50), (0.00,1.30), scores3.02, 3.07, 3.09
    iter=005, params=(0.23,1.36), (0.44,1.33), (0.46,1.50), scores3.01, 3.02, 3.07
    iter=006, params=(0.27,1.26), (0.23,1.36), (0.44,1.33), scores3.00, 3.01, 3.02
    iter=007, params=(0.27,1.26), (0.34,1.32), (0.23,1.36), scores3.00, 3.00, 3.01
    iter=008, params=(0.27,1.32), (0.27,1.26), (0.34,1.32), scores3.00, 3.00, 3.00
    iter=009, params=(0.31,1.31), (0.27,1.32), (0.27,1.26), scores3.00, 3.00, 3.00
