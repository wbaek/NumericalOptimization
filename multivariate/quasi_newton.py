...
def BFGS(derivate, point, direction, step_length, Bk, epsilon=1e-6):
...
def minimize(function, derivate, initial, update_method=SR1, epsilon=1e-6, repeat=int(1e1), verbose=False):
    ...
    iter=000, params=(0.00,5.50), direction=(11.00,-16.00), hessian_inv=([1.00,0.00],[0.00,1.00]), step_length=1.00000, scores=36.50
    iter=001, params=(11.00,-10.50), direction=(-8.21,13.37), hessian_inv=([0.78,0.36],[0.36,0.41]), step_length=1.00000, scores=644.50
    ...
    iter=000, params=(0.00,5.50), direction=(11.00,-16.00), hessian_inv=([1.00,0.00],[0.00,1.00]), step_length=1.00000, scores=36.50
    iter=001, params=(11.00,-10.50), direction=(-8.21,13.37), hessian_inv=([0.78,0.36],[0.36,0.41]), step_length=1.00000, scores=644.50
    iter=002, params=(2.79,2.87), direction=(0.16,0.10), hessian_inv=([0.78,0.36],[0.36,0.42]), step_length=1.00000, scores=0.02
